...
public class Camera {
    ...
    public Camera () {
        ...
        tagIdsSub = tagsTable.getIntegerArrayTopic("tag_id").subscribe(new long[] {});
        ...
        //tags.put(1L, new Tag(1, 0, 0));
        //tags.put(2L, new Tag(2, 0, 0));
        //tags.put(3L, new Tag(3, 0, 0));
    }
    ...
    public void updateInputs() {
        //System.out.println(NetworkTableInstance.kDefaultPort4);
